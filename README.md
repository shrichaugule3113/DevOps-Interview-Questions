...
Travis CI is simple to use with GitHub but less flexible and performant for large projects.
Bamboo integrates well with Atlassian tools but is expensive and less flexible.
